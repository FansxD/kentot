...
def chk():
  ...
  id = "|".join(uuid)
  console.print(" \t By Qusai ",style="bold r s")
  console.print("\n\n\x1b  YOUR ID  :⬇⬇⬇⬇ ",style="bold blue") 
  console.print(id)
  try: 

    httpCaht = requests.get("https://pastebin.com/hMAfUy8Y").text 

    if id in httpCaht: 

      console.print("  ﻞﻌﻔﻣ ﻱﺩ ﻱﻷﺍ. ....... ",style="bold r green") 
      ...
      print("\033[0;96m   ﻡﺍﺮﻐﻠﻴﺗ ﻪﺘﻌﺑﺍﻭ ﻚﻳﺪﻳﺍ ﺦﺴﻧﺍ  ﻞﻌﻔﻣ ﺮﻴﻏ ﻚﻳﺩ ﻱﺍ QUSAI  \033[0;91m#ﻲﻧﺎﺠﻣ ﺲﻴﻟ!!!") 
