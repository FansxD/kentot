...
def __pilih_crack__():
    try:
        ...
        if len(ua_) == 1 and pilih == '4':
            ua = raw_input(h + '\n [' + p + '?' + h + ']' + p + ' Gunakan User-Agent Random?' + a + '[y/n]' + d + 'Recomended  ' + p + ': ')
...
def login():
    ...
    try:
        ...
        print h + ' [' + p + '4' + h + ']' + p + ' Ikuti Instagram' + h + ' alverdoxd'
...
def __menu__(token):
    ...
    try:
        ...
        with requests.Session() as (ses_):
            ...
            print garis
            print h + ' [' + k + '*' + h + ']' + p + ' Tumbal:', a + '[' + p + nama['name'] + a + ']'
            print h + ' [' + k + '*' + h + ']' + p + ' ID :' + h, nama['id']
            print h + ' [' + k + '*' + h + ']' + p + ' Status:' + h + ' Premium'
            print h + ' [' + k + '*' + h + ']' + p + ' expired:' + h + ' unlimited '
            print h + ' [' + k + '*' + h + ']' + p + ' Lisensi:' + a + 'ALVERDO-GANS-XD'
            print h + ' [' + k + '*' + h + ']' + p + ' Max divice:' + p + ' unlimited  '
